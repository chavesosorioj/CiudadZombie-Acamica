...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 170, 280, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 145, 280, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 70, 430, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 280, 100, 30, 30, 1),
    new Obstaculo("imagenes/valla_vertical.png", 480, 480, 30, 30, 1),
    new Obstaculo("imagenes/valla_vertical.png", 480, 460, 30,30, 1),
    new Obstaculo("imagenes/auto_verde_derecha.png", 350, 430, 30, 15, 1),
    new Obstaculo("imagenes/auto_verde_abajo.png", 510, 230, 15, 30, 1),
    new Obstaculo("imagenes/auto_verde_abajo.png", 870, 390, 15, 30, 1),
    new Obstaculo("imagenes/bache.png", 290, 230, 30, 30, 1),
    new Obstaculo("imagenes/bache.png", 500, 120, 30, 30, 1),
    new Obstaculo("imagenes/bache.png", 810, 420, 30, 30, 1),
    new Obstaculo("imagenes/bache.png",820, 90, 30, 30, 1),
    new Obstaculo("imagenes/bache.png",850, 220, 30, 30, 1),
  ...
  new ZombieConductor("imagenes/tren_vertical.png",644,0,30,90,5,{desdeX: 644, hastaX: 644, desdeY: 0, hastaY: 480}, 'vertical'),
  new ZombieConductor("imagenes/tren_vertical.png",678, 0, 30, 90, 5, {desdeX: 644, hastaX: 678, desdeY: 0, hastaY: 480}, 'vertical'),
  new ZombieConductor("imagenes/tren_horizontal.png",0, 322, 90, 30, 1,{desdeX: 0, hastaX: 850, desdeY: 322, hastaY: 322}, "horizontal"),
  

  new ZombieCaminante('imagenes/zombie1.png', 450, 500, 8, 8, 0.3, {desdeX: 350, hastaX: 550, desdeY: 470, hastaY: 500}),
  new ZombieCaminante('imagenes/zombie2.png', 70, 350, 8, 8, 0.3, {desdeX: 70, hastaX: 170, desdeY: 350, hastaY: 410}),
  new ZombieCaminante('imagenes/zombie3.png', 520, 220, 8, 8, 0.3, {desdeX: 500, hastaX: 570, desdeY: 190, hastaY: 260}),
  new ZombieCaminante('imagenes/zombie4.png', 840, 120, 8, 8, 0.3, {desdeX: 820, hastaX: 870, desdeY: 70, hastaY: 160}),
